...
namespace Tema6
{
    class Program
    {
        ...
        {
            var wf = from createReplyResult in BoundedContextDSL.ValidateReply(100, 1, "Raspuns intrebare PSSC")
            ...
            var serviceProvider = new ServiceCollection()
                ...
                .AddOperations(typeof(SendAckToQuestionOwnerAdapter).Assembly)
